...
// Forking config.
var addressFormat = "^amit([a-zA-Z0-9]{95}|[a-zA-Z0-9]{183})$"
var divisor float64 = 10000 // This is 100 for TRTL
var transactionFee = 100 // This is 10 for TRTL
...
func sendTransaction(res http.ResponseWriter, req *http.Request, _ httprouter.Params) {
	...
	if matched, _ := regexp.MatchString("^[0-9]+\\.{0,1}[0-9]{0,4}$", amountStr); !matched {
